...
### pygclib FILE CONSTANTS ### (No standard)

pygclib_DATE = 'date'
pygclib_TIME_FORMAT = '%H:%M'
pygclib_TAKEOFF = 'takeoff'
pygclib_SSS = 'start'
pygclib_ESS = 'ess'
pygclib_GOAL = 'goal'
...
pygclib_TURNPOINTS = 'turnpoints'
pygclib_TURNPOINT_RADIUS = 'radius'
pygclib_TURNPOINT_LAT = 'lat'
pygclib_TURNPOINT_LON = 'lon'
pygclib_TURNPOINT_NAME = 'name'
pygclib_TURNPOINT_ALT = 'altitude'
pygclib_TURNPOINT_ROLE = 'role'
pygclib_TURNPOINT_DESC = 'description'
...
FILE_HEADERS = {'openair': f'** File generated by pygclib - {datetime.datetime.now():%d %B %Y} **\n** Unofficial, use at your own risk. **\n** More info : https://github.com/teobouvard/pygclib **\n'}
